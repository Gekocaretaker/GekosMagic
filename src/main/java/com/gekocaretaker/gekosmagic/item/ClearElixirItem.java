...
public class ClearElixirItem extends ElixirItem {
    public ClearElixirItem(Settings settings) {
        super(settings);
    }

    @Override
    public Text getName(ItemStack stack) {
        return Text.translatable("item.gekosmagic.elixir.basic.effect.water");
    }
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        if (elixirContentsComponent != null) {
            ...
            elixirContentsComponent.buildNoneTooltip(tooltip::add, 1.0F, context.getUpdateTickRate());
        }
    }
}
